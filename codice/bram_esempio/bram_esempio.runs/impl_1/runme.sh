...
HD_PWD='/home/saverio/Scrivania/codice_tesi/bram_esempio/bram_esempio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bram_top.tcl -notrace
