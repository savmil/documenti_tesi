...
HD_PWD='/home/saverio/Scrivania/codice_tesi/bram_esempio/bram_esempio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_top.tcl
