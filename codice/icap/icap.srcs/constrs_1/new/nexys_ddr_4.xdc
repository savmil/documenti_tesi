...
#set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports rst_i]
...
#set_property -dict { PACKAGE_PIN K15 IOSTANDARD LVCMOS33 } [get_ports {state[0]}];
#set_property -dict { PACKAGE_PIN J13 IOSTANDARD LVCMOS33 } [get_ports {state[1]}]; #IO_L17N_T2_A25_15 Sch=led[2]
#set_property -dict { PACKAGE_PIN N14 IOSTANDARD LVCMOS33 } [get_ports q] #IO_L8P_T1_D11_14 Sch=led[3]
set_property -dict { PACKAGE_PIN R18 IOSTANDARD LVCMOS33 }  [get_ports q]
#set_property -dict { PACKAGE_PIN V17 IOSTANDARD LVCMOS33 }  [get_ports {state[4]}] #IO_L18N_T2_A11_D27_14 Sch=led[5]
...
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { state[0] }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { state[1] }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
