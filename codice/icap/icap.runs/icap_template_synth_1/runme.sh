...
HD_PWD='/home/saverio/icap/icap.runs/icap_template_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icap_template.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icap_template.tcl
