...
set DEF_JPROGRAM	   0x0B
set DEF_JSTART	   	   0x0C
set DEF_JSHUTDOWN   	   0x0D
set DEF_ISCPROGRAM         0x10
...
#-------------------------------
  set valWordCount [format "0x%08X" \
       [expr (($DEF_WPF * ($argFrameCount )) + $DEF_FDR_PIPE_DEPTH)]] 
...
proc scrivi_bitstream {file} {
  ...
  global DEF_JPROGRAM
  global DEF_JSTART
  global DEF_ISCPROGRAM
  global optOverwrite
  global DEF_JSHUTDOWN
  ...
  #puts $iRdbkCmdLength
  #puts $sTdiData
  #scan_ir_hw_jtag 6 -tdi $DEF_JSTART
  #runtest_hw_jtag -tck 2000
