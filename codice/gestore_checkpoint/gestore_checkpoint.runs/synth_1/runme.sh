...
HD_PWD='/home/saverio/Scrivania/codice_tesi/gestore_checkpoint/gestore_checkpoint.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gestore_checkpoint.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gestore_checkpoint.tcl
