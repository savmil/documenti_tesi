...
HD_PWD='/home/saverio/Scrivania/codice_tesi/gestore_checkpoint/gestore_checkpoint.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gestore_checkpoint.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gestore_checkpoint.tcl -notrace
