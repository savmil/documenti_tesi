...
set rc [catch {
  ...
  add_files -quiet /home/saverio/Scrivania/codice_tesi/esempio_due_registri/esempio_un_registro.runs/synth_1/top_module.dcp
...
set rc [catch {
  ...
  write_bitstream -force top_module.bit -logic_location_file
