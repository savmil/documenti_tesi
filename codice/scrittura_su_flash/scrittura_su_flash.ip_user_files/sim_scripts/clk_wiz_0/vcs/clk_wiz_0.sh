...
#
# Generated by Vivado on Mon Apr 01 16:02:59 CEST 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../scrittura_su_flash.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../scrittura_su_flash.srcs/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../scrittura_su_flash.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
