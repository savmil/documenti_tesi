...
create_clock -period 10.000 -name synth_clk -waveform {0.000 5.000} -add [get_ports clk]


##Switches

#set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports D]
#set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {in_data[1]}]
...
#set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {uscita[1]}];
...
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { uscita[1] }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { uscita[2] }]; #IO_L17P_T2_A14_D30_14 Sch=led[6]
#set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { uscita[3] }]; #IO_L18P_T2_A12_D28_14 Sch=led[7]
...
#set_property -dhttps://forum.digilentinc.com/topic/17846-nexys-4-store-data-in-flash/?csrfKey=64334ae2d0f599cc7b839f31e9f296ff&do=bestAnswer&answer=45728ict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { ETH_TXD[0] }]; #IO_L14P_T2_SRCC_16 Sch=eth_txd[0]
...
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports wp]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { quad_spi_line[3] }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
